...
The base ResNet is created and trained in Base_ResNet.py. The RG network is created and initialized in RG_ResNet_initialize_to_decimation.py, and then the initialized network is loaded and trained on Chern labels in RG_ResNet_save_intermediate_models.py. Custom losses, functions, and layers are in custom_functions.py.
